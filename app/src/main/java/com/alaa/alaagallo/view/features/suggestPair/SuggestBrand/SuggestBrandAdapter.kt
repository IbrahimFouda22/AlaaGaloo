...
//import com.ibrahimm.alaagallo.model.brands.Data
import com.alaa.alaagallo.model.brands.DataBrand
import com.alaa.alaagallo.view.features.suggestPair.Suggestion
import com.alaa.alaagallo.view.home.IHome
import com.squareup.picasso.Picasso

class SuggestBrandAdapter (private val brandsCallBack: IHome): RecyclerView.Adapter<SuggestBrandAdapter.ViewHolder>() {
...
//            setBrandData(brandsList[position])
            brandsCallBack.sendSubCategoriesData(brandsList[position].name,
                brandsList[position].id.toString(),"")
        }
    }
    ...
    private fun setBrandData(brand: Brand) {
        Suggestion.brandImage = brand.brandImage
        Suggestion.brandId = brand.brandId
    }
